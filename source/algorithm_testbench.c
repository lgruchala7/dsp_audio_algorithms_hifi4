 ...
 ******************************************************************************/
#ifndef Q31
float32_t fir_state_f32_1[BLOCK_SIZE + FIR_COEFF_COUNT - 1];
float32_t fir_state_f32_2[BLOCK_SIZE + FIR_COEFF_COUNT - 1];
...
#else
q31_t fir_state_q31_1[BLOCK_SIZE + FIR_COEFF_COUNT - 1];
q31_t fir_state_q31_2[BLOCK_SIZE + FIR_COEFF_COUNT - 1];
